...
pub int GenContents(FILE *xmlout, int type) {
    ...
    switch(type) {
        case CITY:
            xmlprintf(xmlout, "%s", cities[ignuin(0,cities_len-1)]);
            break;
        case TYPE:
            xmlprintf(xmlout, "%s", GenContents_auction_type[ignuin(0,1)]);
        ...
        case COUNTRY:
            ...
            xmlprintf(xmlout, "%s", countries[GenContents_country]);
            break;
        case PROVINCE:
            if (GenContents_country==countries_USA)
                xmlprintf(xmlout,"%s", provinces[ignuin(0,provinces_len-1)]);
            else
                xmlprintf(xmlout,"%s", lastnames[ignuin(0,lastnames_len-1)]);
            break;
        case EDUCATION:            
            xmlprintf(xmlout, "%s", GenContents_education[ignuin(0,3)]);
            break;
        case STATUS:
        case HAPPINESS:
