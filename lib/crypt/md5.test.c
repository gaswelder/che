...
int main() {
	...
	test.streq("d174ab98d277d9f5a5611c2c9f419d9f", hash("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
	test.streq("57edf4a22be3c955ac49da2e2107b67a", hash("12345678901234567890""123456789012345678901234567890123456789012345678901234567890"));
	return test.fails();
}
